...
from pydass_vasp.electronic_structure import get_ldos
get_ldos(atom=args.atom, input_file=args.i, ISPIN=args.ISPIN, LORBIT=args.LORBIT, plot=True, xlim=args.xlim, ylim_upper=args.ylim_upper)
