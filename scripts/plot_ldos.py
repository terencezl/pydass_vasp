...
parser.add_argument('--ylim_upper', type=eval, help="the upper limit of y-axis(, of the spin-combined plot if ISPIN == 2) \
...
plot_ldos(atom=args.atom, input_file=args.input, ISPIN=args.ISPIN, LORBIT=args.LORBIT, xlim=args.xlim, ylim_upper=args.ylim_upper,
          display=display, return_refs=False, save_figs=save_figs, save_data=args.save_data, output_prefix=args.output_prefix)